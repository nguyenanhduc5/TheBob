...
export default function Checkout() {
  ...
  const handleProvinceChange = async (e) => {
    ...
    setFormData((prev) => ({ ...prev, provinceCity: province?.name || '', district: '', ward: '' }));
          ...
          <form onSubmit={handleSubmitOrder} className="checkout-form">
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                ...
                <select
                  value={provinces.find((item) => item.name === formData.provinceCity)?.code || ''}
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <select
                    value={districts.find((item) => item.name === formData.district)?.code || ''}
                ...
                <div className="form-group">
                  ...
                  <select
                    value={wards.find((item) => item.name === formData.ward)?.code || ''}
            ...
            <div className="form-section">
              ...
              <div className="payment-options">
                {/* FIX: toàn bộ ô là <label> — click đâu cũng tích được */}
